...
TOOL_CATEGORY = {
    ...
    "graph": "graph", "graph_analysis": "graph",
    "get_connection_strength": "graph", "list_entities": "graph",
    "get_link_path": "graph", "get_common_neighbors": "graph",
    "get_backlinks": "graph", "get_forward_links": "graph", "get_strong_connections": "graph",
    "schema": "schema", "vault_schema": "schema", "schema_conventions": "schema",
    "schema_validate": "schema", "note_intelligence": "schema",
    "rename_field": "schema", "migrate_field_values": "schema", "rename_tag": "schema",
    "link": "wikilinks", "suggest_wikilinks": "wikilinks", "validate_links": "wikilinks",
    ...
    "correct": "corrections", "vault_record_correction": "corrections",
    "vault_list_corrections": "corrections", "vault_resolve_correction": "corrections",
    "absorb_as_alias": "corrections",
    "tasks": "tasks", "vault_toggle_task": "tasks", "vault_add_task": "tasks",
    "memory": "memory", "brief": "memory",
    "entity": "note-ops", "vault_delete_note": "note-ops", "vault_move_note": "note-ops",
    ...
    "insights": "diagnostics", "pipeline_status": "diagnostics",
    "refresh_index": "diagnostics", "vault_growth": "diagnostics",
