 ...
 *
 * Tools: refresh_index, list_entities, suggest_entity_aliases, unlinked_mentions_report
 */
...
export function registerSystemTools(
  ...
  // list_entities retired (T43 B3+) — use entity(action: list) instead

  // suggest_entity_aliases retired (T43 B3+) — use entity(action: suggest_aliases) instead

  // unlinked_mentions_report retired (T43) — functionality absorbed into link tool (action: unlinked)
}
