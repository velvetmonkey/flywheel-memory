...
export {
  ...
  saveBaseline,
  loadBaseline,
  formatRegressionsForCI,
  exitIfRegressions,
  DEFAULT_THRESHOLDS
} from './harness/regression.js';
...
export {
  ...
  runGitMaintenance,
  getGitStats,
  measureGitPerformance
} from './iteration/gitHealthChecker.js';
export {
  PerformanceTracker,
  timeOperation,
  timeAsyncOperation
...
export {
  ...
  type IterationStressResult
} from './iteration/index.js';

// Logging
export {
  OperationLogger,
  createLoggerFromVault,
  loadFlywheelConfig,
  formatMetricsReport
