...
- [The Flywheel Effect](#the-flywheel-effect)
  ...
  - [Month 1](#month-1)
  - [Month 3](#month-3)
  - [Proactive Linking: The Watcher Closes the Loop](#proactive-linking-the-watcher-closes-the-loop)
- [Phase 1: Filtering (Layers 1-2)](#phase-1-filtering-layers-1-2)
  - [Layer 1: Length & Pattern Filter](#layer-1-length--pattern-filter)
  - [Layer 2: Article & Suppression Filter](#layer-2-article--suppression-filter)
- [Phase 2: Scoring (Layers 3-13)](#phase-2-scoring-layers-3-13)
  - [Layer 3: Exact Match](#layer-3-exact-match)
  - [Layer 4: Stem Match](#layer-4-stem-match)
  - [Layer 5: Co-occurrence](#layer-5-co-occurrence)
  - [Layer 6: Type Boost](#layer-6-type-boost)
  - [Layer 7: Context Boost](#layer-7-context-boost)
  - [Layer 8: Recency](#layer-8-recency)
  - [Layer 9: Cross-Folder](#layer-9-cross-folder)
  - [Layer 10: Hub Boost](#layer-10-hub-boost)
  - [Layer 11: Feedback Adjustment](#layer-11-feedback-adjustment)
  - [Layer 12: Semantic Similarity](#layer-12-semantic-similarity)
  - [Layer 13: Edge Weight](#layer-13-edge-weight)
...
- [Worked Example](#worked-example)
  - [Candidates after filtering](#candidates-after-filtering)
  - [Marcus Johnson (people, path: `people/Marcus Johnson.md`)](#marcus-johnson-people-path-peoplemarcus-johnsonmd)
  - [Acme Corp (organizations, path: `organizations/Acme Corp.md`)](#acme-corp-organizations-path-organizationsacme-corpmd)
  - [Turbopump (projects, path: `projects/Turbopump.md`)](#turbopump-projects-path-projectsturbopumpmd)
  - [Final ranking](#final-ranking)
  - [Three months later: same content, different scores](#three-months-later-same-content-different-scores)
  - [Marcus Johnson (3 months of usage)](#marcus-johnson-3-months-of-usage)
- [The Self-Correcting Loop](#the-self-correcting-loop)
  - [Implicit Feedback](#implicit-feedback)
  - [Survival Tracking](#survival-tracking)
  - [Edge Weight Accumulation](#edge-weight-accumulation)
  - [Suppression](#suppression)
- [Vectors + Structure: Deeply Integrated](#vectors--structure-deeply-integrated)
- [Search Pipeline](#search-pipeline)
  - [Query Routing](#query-routing)
  - [Three Search Channels (Structured Response)](#three-search-channels-structured-response)
  - [Reciprocal Rank Fusion (RRF)](#reciprocal-rank-fusion-rrf)
  - [Result Enrichment (P38 Context Engineering)](#result-enrichment-p38-context-engineering)
  - [U-Shaped Interleaving (Lost in the Middle)](#u-shaped-interleaving-lost-in-the-middle)
  - [Section Expansion (Dual-Granularity)](#section-expansion-dual-granularity)
  - [Contextual Embedding Prefix](#contextual-embedding-prefix)
...
**Alongside the scoring pipeline** -- Note-level embeddings power `search` (hybrid mode) for both `action=query` and `action=similar` via Reciprocal Rank Fusion. These serve a different purpose from wikilink scoring: broad discovery and exploration across the vault rather than per-entity suggestion.
